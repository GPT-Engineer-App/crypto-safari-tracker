...
**Project**: crypto-safari-tracker 

**URL**: https://run.gptengineer.app/projects/REPLACE_WITH_PROJECT_ID/improve

**Description**: Can you make an a for tracking crypto coins 
...
```sh
git clone https://github.com/GPT-Engineer-App/crypto-safari-tracker.git
cd crypto-safari-tracker
npm i
